        ...
        foreach ($__currentLoopData as $key => $product): $__env->incrementLoopIndices();
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <div class="product-item">
                    <div class="item-img">
                        <img src="<?php echo url(@$product->defaultImage('md', 'images')); ?>" class="img-responsive"
                             alt="">
                    </div>
                    <!-- <div class="item-new">
                        <p>New</p>
                    ...
                    <div class="item-links">
                        ...
                        <a href="<?php echo url('products'); ?>/<?php echo @$product['slug']; ?>" class="links-item"><i
                                    class="fa fa-eye"
