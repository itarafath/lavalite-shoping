    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <h5>About us</h5>
                <hr>
                <p>You wanna be where you can see our troubles are all the same. You wanna be where everybody knows Your
                    name. Here's the story of a their tropic island nest.</p>
                <ul class="social_icons">
                    <li class="facebook"><a target="new" href="http://facebook.com"><i class="fa fa-facebook"></i> </a>
                    </li>
                    <li class="twitter"><a target="new" href="http://twitter.com"><i class="fa fa-twitter"></i> </a>
                    </li>
                    <li class="linkedin"><a target="new" href="http://linkedin.com"><i class="fa fa-linkedin"></i> </a>
                    </li>
            ...
            <div class="col-sm-3">
                ...
                <ul class="useful-links">
                    <?php if (user('client.web')): ?>
                        <li>
                            <a href="<?php echo url('client'); ?>"><?php echo e(ucFirst(user('client.web')->name)); ?></a>
                        </li>
                    <?php else: ?>
