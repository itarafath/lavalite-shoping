                ...
                foreach ($__currentLoopData as $key => $row): $__env->incrementLoopIndices();
                    ...
                    <div class="cart-item product-summary mt10 mr10">
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="image">
                                    <a href="<?php echo url('products'); ?>/<?php echo @$product->slug; ?>"><img
                                                src="<?php echo url(@$product->defaultImage('sm', 'images')); ?>"
                                                alt=""></a>
                                </div>
                            </div>
                            <div class="col-xs-7">
                                <h3 class="name"><a
                                            href="<?php echo url('products'); ?>/<?php echo @$product->slug; ?>"><?php echo e($row->name); ?>
                                        (<?php echo e($row->qty); ?>)</a></h3>
