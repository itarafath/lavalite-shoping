                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table">
                                ...
                                <td colspan="7">
                                    <div class="shopping-cart-btn">
                                                    <span class="">
                                                        ...
                                                        <a id="clear-cart"
                                                           class="btn btn-upper btn-primary pull-right mr10 outer-right-xs" ">Clear shopping cart</a>
                                                    </span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            foreach ($__currentLoopData as $key => $row): $__env->incrementLoopIndices();
                                ...
                                <tr id="<?php echo e($row->rowId); ?>">
                                    <td class="romove-item"><a title="cancel" class="btn btn-danger btn-xs remove-cart"><i
                                                    class="fa fa-trash-o "></i></a></td>
                                    <td class="cart-image">
                                        <a class="entry-thumbnail"
                                           href="<?php echo url('products'); ?>/<?php echo @$product->slug; ?>">
                                            <img src="<?php echo url(@$product->defaultImage('xs', 'images')); ?>"
                                                 class="img-responsive" alt="">
                                        </a>
                                    </td>
                                    <td class="cart-product-name-info">
                                        <h4 class='cart-product-description'><a
                                                    href="<?php echo url('products'); ?>/<?php echo @$product->slug; ?>"><?php echo e($row->name); ?></a>
                                        </h4>
                                    ...
                                    <td class="cart-product-quantity">
                                        <div class="col-md-10 quant-input">
                                            <input type="number" name="qty[<?php echo e($key); ?>]"
                                                   value="<?php echo e($row->qty); ?>"
                                                   id="qty<?php echo e($row->rowId); ?>" min="1" class="form-control">

                                        </div>
                                        <div class="col-md-2"><a><i style="zoom:2;" class="fa fa-refresh edit-cart"
                                                                    aria-hidden="true"></i></a></div>
                                    </td>
                                    <td class="cart-product-sub-total"><span
                                                class="cart-sub-total-price">$<?php echo e($row->price); ?> USD</span>
                                    </td>
                                    <td class="cart-product-grand-total"><span
                                                class="cart-grand-total-price">$<?php echo e($row->total); ?> USD</span>
                                    </td>
                                </tr>
                            <?php endforeach;
                            $__env->popLoop();
                ...
                <div class="col-md-4 col-sm-12 estimate-ship-tax">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <input type="text" name="coupon" id="add-coupon"
                                           class="form-control unicase-form-control text-input"
                                           placeholder="You Coupon..">
                                </div>
                                <div class="clearfix pull-right">
                                    <button type="submit" id="apply-coupon" class="btn-upper btn btn-primary">Apply
                                        Coupon
                                    </button>
                                </div>
                            </td>
                        ...
                        <tr>
                            <th>
                                <div class="cart-sub-total">
                                    Total<span class="inner-left-md">$<?php echo e(Cart::total()); ?> USD</span>
                                </div>
                                <div class="cart-grand-total text-primary">
                                    Grand Total<span class="inner-left-md"
                                                     id="coupon-subtotal">$<?php echo e(Cart::subtotal()); ?> USD</span>
                                </div>
                            </th>
...
<script type="text/javascript">
    ...
    $(".edit-cart").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('carts/cart/edit')); ?>",
            data: "id=" + id + "&qty=" + qty,
            dataType: 'html',
            success: function (data, textStatus, jqXHR) {
    ...
    $("#clear-cart").click(function () {
        ...
        $.ajax({
            url: '<?php echo e(URL::to('carts/cart/clear')); ?>',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
    ...
    $("#update-cart").click(function () {
        ...
        $.ajax({
            url: '<?php echo e(URL::to('carts/cart/update')); ?>',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
    ...
    $("#apply-coupon").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('coupons/coupon/check')); ?>",
            data: "coupon=" + coupons,
            dataType: 'html',
            success: function (data, textStatus, jqXHR) {
