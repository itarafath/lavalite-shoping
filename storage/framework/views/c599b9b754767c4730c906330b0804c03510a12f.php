...
<section class="banner">
    <div class="container">
        <div class="row">
            <div class="col-md-6"><img src="img/promo/sub-banner4.jpg" class="img-responsive banner-border" alt="">
            </div>
            <div class="col-md-6"><img src="img/promo/sub-banner5.jpg" class="img-responsive banner-border" alt="">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="ex-right">
                    <div class="ex-left-text ex-left-right">
                        ...
                        <a href="<?php echo e(trans_url('/products')); ?>">view collection</a>
                    </div>
                </div>
            </div>
        </div>
