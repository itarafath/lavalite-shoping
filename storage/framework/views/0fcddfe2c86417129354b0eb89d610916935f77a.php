                    ...
                    <ul class="rel-ls-none rel-ls-inline">
                        ...
                        <li class="dropdown pull-right">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false"><span class="fa fa-user-circle"></span>My
                                Account</a>
                            <ul class="dropdown-menu">
                                <?php if (user('client.web')): ?>
                                    <li>
                                        <a href="<?php echo url('client'); ?>"><?php echo e(user('client.web')->name); ?></a>
                                    </li>
                                <?php else: ?>
    ...
    <nav class="navbar yamm navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(trans_url('/')); ?>"><img
                            src="<?php echo e(trans_url('img/logo-white.png')); ?>" class="logo-white" alt=""><img
                            src="<?php echo e(trans_url('img/logo.png')); ?>" class="logo-color" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php $__empty_1 = true;
                    $__currentLoopData = Category::category();
                    ...
                    foreach ($__currentLoopData as $key => $value): $__env->incrementLoopIndices();
                        ...
                        <li class="dropdown yamm-fw"><a href="#" data-toggle="dropdown"
                                                        class="dropdown-toggle"><?php echo @$value->name; ?></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <div class="yamm-content">
                                        <div class="row">
                                            <?php $__empty_2 = true;
                                            $__currentLoopData = $value['child'];
                                            $__env->addLoop($__currentLoopData);
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                    ...
                                                    <ul class="links">
                                                        ...
                                                        foreach ($__currentLoopData as $key => $subchild): $__env->incrementLoopIndices();
                                                            ...
                                                            $__empty_3 = false; ?>
                                                            <li>
                                                                <a href="<?php echo url('categories'); ?>/<?php echo @$subchild['slug']; ?>"><?php echo @$subchild->name; ?></a>
                                                            </li>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                <img class="img-responsive" style="padding:10px; margin-left:380px;"
                                                     src="<?php echo url(@$value->defaultImage('lg', 'image')); ?>"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
