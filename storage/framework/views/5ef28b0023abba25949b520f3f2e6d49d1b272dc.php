        ...
        <div class="card card-signup">
            ...
            <div class="header header-primary text-center">
                ...
                <div class="social-line">
                    <a href="<?php echo trans_url($guard . '/login/facebook'); ?>" class="btn btn-simple btn-just-icon"><i
                                class="fa fa-facebook" aria-hidden="true"></i></a>
                    <a href="<?php echo trans_url($guard . '/login/twitter'); ?>"
                       class="btn btn-simple btn-just-icon"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                    <a href="<?php echo trans_url($guard . '/login/google'); ?>" class="btn btn-simple btn-just-icon"><i
                                class="fa fa-google-plus" aria-hidden="true"></i></a>
                    <a href="<?php echo trans_url($guard . '/login/linkedin'); ?>" class="btn btn-simple btn-just-icon"><i
            ...
            <div class="content">
                ...
                <div class="input-group">
                    ...
                    <div class="form-group label-floating">
                        <label for="username"
                               class="control-label"><?php echo trans('client.confirm_password'); ?></label>
            ...
            <div class="footer text-center mt20">
                <button type="submit"
                        class="btn btn-raised btn-danger"><?php echo trans('client.register_now'); ?></button>
            </div>
            <?php echo Form::close(); ?>
