        ...
        <div class="row">
            ...
            <div class="col-md-4 sidebar">
                ...
                <div class="widget">
                    <h3>Price</h3>
                    <hr>
                    {!!Form::vertical_open()->method('GET')->id('filterprice')!!}
                    <div class="row">
                        <div class="col-xs-6">
                            <input type="number" name="search[price][min]" id="price-min"
                                   value="{{Request::input('search.price.min')}}" class="form-control chosen-select"
                                   required="required" placeholder="Min"/>

                        </div>
                        <div class="col-xs-6">
                            <input type="number" name="search[price][max]" id="price-max"
                                   value="{{Request::input('search.price.max')}}" class="form-control chosen-select"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="shop-view-area">
                            <div class="row">
                                {!!Form::vertical_open()->method('GET')->id('filtersort')!!}
                                ...
                                {!!Form::vertical_open()->method('GET')->id('filtershow')!!}
                                <div class="col-md-4 col-sm-4 hidden-xs">
                                    <div class="shop-tab-pill show">
                                        <div class="show-label text-right">

                                            {!! Form::select('search[show]')
                    ...
                    @forelse($products as $key => $product)
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="product-item">
                                <div class="item-img">
                                    <img src="{!!url(@$product->defaultImage('md','images'))!!}" class="img-responsive"
                                         alt="">
                                </div>
                                <!--                                     <div class="item-new">
                                                                        <p>New</p>
                                ...
                                <div class="item-links">
                                    ...
                                    <a href="{!!url('products')!!}/{!!@$product['slug']!!}" class="links-item"><i
                                                class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a id="{!!$product->id!!}" class="add-cart links-item"><i
                                                class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                    @if(user('client.web'))
                                        @if(!user('client.web')->product->contains($product->id))
                                            <a id="{!!$product->getRouteKey()!!}" class="fav-prop links-item"><i
