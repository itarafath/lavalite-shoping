    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class='pull-right'>
                ...
                <a href="{{ trans_url('/user/product/product') }}/{{ product->getRouteKey() }}/edit"
                   class="btn btn-success"> {{ trans('app.edit')  }}</a>
                <a href="{{ trans_url('/user/product/product') }}/{{ product->getRouteKey() }}/copy"
                   class="btn btn-warning"> {{ trans('app.copy')  }}</a>
                <a href="{{ trans_url('/user/product/product') }}/{{ product->getRouteKey() }}/delete"
