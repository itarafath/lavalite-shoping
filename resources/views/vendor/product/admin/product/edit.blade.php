<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs primary">
        ...
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-primary btn-sm" data-action='UPDATE' data-form='#product-product-edit'
                    data-load-to='#product-product-entry' data-datatable='#product-product-list'><i
            ...
            <button type="button" class="btn btn-default btn-sm" data-action='CANCEL'
                    ...
                    data-href='{{trans_url('admin/product/product')}}/{{$product->getRouteKey()}}'><i
