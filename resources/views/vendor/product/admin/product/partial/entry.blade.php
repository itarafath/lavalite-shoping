<div class="tab-pane active" id="details">
    <div class="tab-pan-title">  @if(empty($product->id)) {{ trans('app.new') }}
        [{!! trans('product::product.name') !!}] @else {!! trans('product::product.name') !!} [{!!$product->name!!}
        ] @endif </div>
    ...
    <div class='col-md-6 col-lg-6'>
        <div class="form-group form-group-sm">
            ...
            <div class="col-lg-2 col-md-2 col-sm-3">
                <button type="button" class="btn btn-primary btn-sm" id="btn-add-contact"><i
            ...
            <table id="activity-activity-list" class="table table-striped  data-table">
                ...
                @forelse($product->categories as $key => $val)
                    ...
                    <tr id="{!! @$val->getRouteKey() !!}" class="activity-edit">
                        <td><input type="hidden" name="category[{{$key}}]" class="check_exist"
                                   value="{!! @$val->id !!}">{!! @$val->name !!}</td>
                        <td>
                            <div class="form-actions pull-right"><a class="btn-contact-remove text-danger"><i
    ...
    <div class='row'>
        ...
        <div class='col-md-4 col-lg-4'>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <button type="button" class="btn btn-primary btn-sm" id="btn-add-product"><i
                            class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add
                </button>
            </div>
            ...
            <table id="attribute-attribute-list" class="table table-striped  data-table">
                ...
                @forelse(@$product->attributes as $key => $val)
                    ...
                    <tr id="{!! @$val->getRouteKey() !!}" class="product-edit">
                        ...
                        <td><input type="hidden" name="attribute[{{$key}}]" class="check_exist"
                                   value="{!! @$val->id !!}">{!! @$val->name!!}</td>
                        <td>{{$val->group->name}}</td>
                        <td>
                            <div class="form-actions pull-right"><a class="btn-product-remove text-danger"><i
                                            class="fa fa-trash"></i></a></div>
                        </td>
                    </tr>
                @empty
