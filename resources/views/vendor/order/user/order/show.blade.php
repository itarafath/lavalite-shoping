                ...
                <div class="card">
                    <div class="header with-sub" data-background-color="red">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <a href="{{trans_url(get_guard('url').'/order/order')}}" rel="tooltip"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="col-md-12">
                            <h4 class="text-bold  header-title m-t-0" style="font-weight:500;">Order Information <span
                                        class="pull-right">Order Status : {{ @$order->status->name }}</span></h4>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @forelse(@$order->products as $key => $val)
                                <tr>
                                    ...
                                    <td class="text-right">${!!@number_format($val->pivot->quantity*$val->price,2)!!}
                                        USD
                                    </td>
                                    <?php
                                    ...
                                    ?>
                                    <td class="td-actions">
                                        <a id="id-{!!$val->id!!}" rel="tooltip" data-toggle="tooltip"
                                           data-placement="top" title="Return"
                                           class="btn btn-raised btn-danger btn-fab-mini return-order">
                            ...
                            @if($order->coupon_id!=NULL)
                                <tr>
                                    ...
                                    @else
                                        <th class="text-right" colspan="4">Discount</th>
                                        <td class="text-right">${!!@number_format($order->coupon->discount,2)!!}USD
                                        </td>
                                    @endif
                    ...
                    <div class="footer">
                        <a href="{{ trans_url(get_guard('url').'/order/order') }}"
                           class="btn-danger btn-raised btn btn-sm">Back</a>
                    </div>
                </div>
            </div>
        </div>
