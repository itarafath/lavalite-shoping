    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class='pull-right'>
                <a href="{{ trans_url('/user/order/order_status') }}"
                   class="btn btn-default"> {{ trans('app.back')  }}</a>
                <a href="{{ trans_url('/user/order/order_status') }}/{{ order_status->getRouteKey() }}/edit"
                   class="btn btn-success"> {{ trans('app.edit')  }}</a>
                <a href="{{ trans_url('/user/order/order_status') }}/{{ order_status->getRouteKey() }}/copy"
                   class="btn btn-warning"> {{ trans('app.copy')  }}</a>
                <a href="{{ trans_url('/user/order/order_status') }}/{{ order_status->getRouteKey() }}/delete"
