                            ...
                            <div class="col-sm-4">
                                <div class="header-form">
                                   ...
                                   ->action(trans_url(get_guard('url').'/order/order_status'))!!}
                                    ...
                                    {!! Form::close()!!}
                                    <a href="{!!trans_url(get_guard('url').'/order/order_status/create')!!}"
                                       rel="tooltip"
                                        ...
                                        <div class="img-container">
                                            <a href="{{trans_url('order_status')}}/{{$order_status->getPublickey()}}">
                                                <img alt="" class="img-responsive"
                                                     src="{!!url($order_status->defaultImage('sm','images'))!!}">
                                            </a>
                                        </div>
                                    </td>
                                    <td>{{ $order_status->name }}</td>
                                    <td class="td-actions">
                                        <a href="{{trans_url('order_status')}}/{!!$order_status->getRouteKey()!!}"
                                           rel="tooltip" data-toggle="tooltip" data-placement="top"
                                           title="View OrderStatus" class="btn btn-info btn-simple">
                                            <i class="material-icons">panorama</i>
                                        </a>
                                        <a href="{!! trans_url(get_guard('url').'/order/order_status') !!}/{!! $order_status->getRouteKey() !!}/edit"
                                           rel="tooltip" data-toggle="tooltip" data-placement="top"
                                           title="Edit OrderStatus" class="btn btn-success btn-simple">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a rel="tooltip" data-toggle="tooltip" data-placement="top"
                                           title="Remove OrderStatus" class="btn btn-danger btn-simple"
                                           data-action="DELETE"
                                           data-href="{!! trans_url(get_guard('url').'/order/order_status') !!}/{!! $order_status->getRouteKey() !!}"
                                           data-remove="{!! $order_status->getRouteKey() !!}">
