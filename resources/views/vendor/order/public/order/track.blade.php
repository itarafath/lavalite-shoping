            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="order_id" class="form-control unicase-form-control text-input"
                    ...
                    <button type="button" id="track-order" class="btn-upper btn btn-primary checkout-page-button">
                        Track
                    </button>
                    {!! Form::close() !!}
                </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer ">
                <a type="button" class="btn btn-primary pull-right btn-sm m-l-5" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
</div>
