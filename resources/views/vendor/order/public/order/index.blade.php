                                                        ...
                                                        @if(user('client.web'))
                                                            <div class="row" id="payment-existing">
                                                                <select name="address_id" class="form-control">
                                                                    <option value="{!!user('client.web')->name!!},{!!user('client.web')->address!!},{!!user('client.web')->district!!},{!!user('client.web')->city!!},{!!user('client.web')->country!!},{!!user('client.web')->state!!}"
                                                                            selected="selected">{!!@user('client.web')->name!!}
                                                                        ,{!!@user('client.web')->address!!}
                                                                        ,{!!@user('client.web')->district!!}
                                                                        ,{!!@user('client.web')->city!!}
                                                                        ,{!!@user('client.web')->country!!}
                                                                        ,{!!@user('client.web')->state!!}</option>
                                                                </select>
                                                            </div>
                                                        @endif
                                                        <br>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    @forelse(Cart::content() as $key=>$row)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">${{number_format($row->total,2)}}
                                                                USD
                                                            </td>
                                                        </tr>
                                                    @empty
                                                    ...
                                                    @else
                                                        <tr>
                                                            @if($coupon->type=='Percentage')
                                                                ...
                                                                <td class="text-right">
                                                                    ${{number_format($coupon->discount)}} USD
                                                                </td>
                                                            @else
                                                                <td colspan="3" class="text-right">Discount</td>
                                                                <td class="text-right">
                                                                    ${{number_format($coupon->discount,2)}} USD
                                                                </td>
                                                            @endif
                                                        ...
                                                        <tr>
                                                            <td colspan="3" class="text-right">Total</td>
                                                            <td class="text-right">${{number_format($result,2)}}USD
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    </tbody>
