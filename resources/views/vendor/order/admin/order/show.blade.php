<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs primary">
        ...
        <div class="box-tools pull-right">
            ...
            @if($order->id )
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" href="#popup-history"
                        id="history"><i class="fa fa-plus-circle"></i> Add History
                </button>
            @endif
        <!-- <button type="button" class="btn btn-success btn-sm" data-action='NEW' data-load-to='#order-order-entry' data-href='{{trans_url('admin/order/order/create')}}'><i class="fa fa-plus-circle"></i> {{ trans('app.new') }}</button> -->
            ...
            <!-- <button type="button" class="btn btn-primary btn-sm" data-action="EDIT" data-load-to='#order-order-entry' data-href='{{ trans_url('/admin/order/order') }}/{{$order->getRouteKey()}}/edit'><i class="fa fa-pencil-square"></i> {{ trans('app.edit') }}</button> -->
                <button type="button" class="btn btn-danger btn-sm" data-action="DELETE"
                        data-load-to='#order-order-entry' data-datatable='#order-order-list'
                        data-href='{{ trans_url('/admin/order/order') }}/{{$order->getRouteKey()}}'>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer ">
                <a type="button" class="btn btn-danger pull-right btn-sm m-l-5" data-dismiss="modal"><i
                            class="fa fa-times-circle"></i>&nbsp;&nbsp;Cancel</a>
                <button type="button" id="history-save" class="btn btn-primary btn-sm" id="btn-block"><i
