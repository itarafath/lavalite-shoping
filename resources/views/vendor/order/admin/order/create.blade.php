<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs primary">
        ...
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-primary btn-sm" data-action='CREATE' data-form='#order-order-create'
                    data-load-to='#order-order-entry' data-datatable='#order-order-list'><i
                        class="fa fa-floppy-o"></i> {{ trans('app.save') }}</button>
            <button type="button" class="btn btn-default btn-sm" data-action='CLOSE' data-load-to='#order-order-entry'
                    data-href='{{trans_url('admin/order/order/0')}}'><i
